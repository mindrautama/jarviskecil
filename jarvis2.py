...
VOICE_ID = "21m00Tcm4TlvDq8ikWAM" # GANTI DENGAN ID SUARA LAKI-LAKI PILIHAN ANDA

# URL endpoint Eleven Labs Text-to-Speech
ELEVEN_LABS_URL = f"https://api.elevenlabs.io/v1/text-to-speech/l88WmPeLH7L0O0VA9lqm"
...
def get_audio_input():
    ...
    with sr.Microphone() as source:
        print("Dengarkan...")
        r.pause_threshold = 0.5 # jeda singkat untuk memastikan kalimat selesai diucapkan
...
if __name__ == "__main__":
    ...
    while True: # Loop agar Jarvis bisa terus menerima pertanyaan
        ...
        if user_input_text.lower() == "berhenti":
            ...
            response = llm_chain.invoke({"pertanyaan": user_input_text})['text']
            speak(response) # Jarvis merespons dengan suara
        else:
